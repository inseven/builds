...
Builds is licensed under the MIT License (see [LICENSE](https://github.com/inseven/builds/blob/main/LICENSE)). It depends on the following separately licensed third-party libraries and components:
